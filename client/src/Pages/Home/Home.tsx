...
import { Building2, Download, File, Filter, LogOut, Search, Shield, Trash2, Upload, User } from "lucide-react"
...
const Home = () => {
    const [user, setUser] = useState<{ id: string; role: string; email: string } | null>({
        id: "u1",
        role: "admin",
        email: "123@gmail.com"
    })
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2.5 px-3 py-1.5 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 capitalize">Hi {user.role}!</p>
                    </div>
                  </div>
                  <button
